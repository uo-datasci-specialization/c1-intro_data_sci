...
| 2a <br/>(Oct 1)  | Introduction to data visualization             | Data visualization with ggplot2; Grammar of Graphics                                                                    | Scatterplots with smooths, line plots                                                             | Lab                                                            | RStudio IDE DC 3<br/>Intro to Tidyverse DC  2<br/>Final Project Groups Finalized | MD 3.1-3.4<br/>R4DS 3.1-3.6                                                             |
| 2b <br/>(Oct 3)  |                                                | More data vis basics with ggplot2                                                                                       | histograms, boxplots, barplots                                                                    | Lab<br/>Intro to Tidyverse DC 4                                | Lab (Scatterplots with smooths, line plots)                                      | MD 3.5-3.9<br/>R4DS 3.7-3.10<br/>Healy 3                                                |
...
| 3b<br/>(Oct 10)  |                                                | More data wrangling with dplyr                                                                                          | The lesser known stars of dplyr                                                                   | Lab                                                            | Lab (importing, skimming, and summarizing)<br/>Intro to Tidyverse DC 3           | R4DS 5<br/>MD 5.9                                                                       |
...
| 5b<br/>(Oct 24)  |                                                | Citations, equations, and formatting concerns                                                                           | Prettifying your APA doc                                                                          | Lab<br/>Data in the Tidyverse DC 1 & 2                         | Final Project Outline<br/>Lab (Transform your prior Rmd to an APA Doc)           | Aust & Barth: 3-4                                                                       |
| 6a<br/>(Oct 29)  | Tidy data 1                                    | Taming and tidying data                                                                                                 | Data in the Tidyverse DC 3                                                                        | Lab                                                            | Data in the Tidyverse DC 1 & 2<br/>LAB (Prettifying your doc)                    | R4DS12<br/>Wickham (2014): http://www.jstatsoft.org/v59/i10/paper<br/>MD 4.1 - 4.2; 4.4 |
| 6b<br/>(Oct 31)  |                                                | Taming variables                                                                                                        | Data in the Tidyverse DC 4                                                                        | Lab<br/>Categorical Data DC 1-3                                | <br/>Lab (Data in the Tidyverse DC 3)                                            | R4DS 14, 16                                                                             |
| 7a<br/>(Nov 5)   | Taming unwieldy variables                      | Taming variables (Part 2)                                                                                               | Categorical Data DC 4                                                                             | Lab                                                            | Lab (Data in the Tidyverse DC 4)<br/>Categorical Data DC (Ch 1-3)                            | R4DS 15                                                                                 |
| 7b<br/>(Nov 7)   |                                                | Work day: (import + tame + tidy)                                                                                        |                                                                                                   |                                                                | Lab (Categorical Data DC 4)                                                                  |                                                                                         |
