...
| :--------------: | :--------------------------------------------: | :---------------------------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------: | :------------------------------------------------------------: | :------------------------------------------------------------------------------: | :-------------------------------------------------------------------------------------- |
| 1a <br/>(Sep 25) | Introduction to the course and getting started | Oh the places you'll go! An overview of the course and (some of) the R ecosystem                                        |                                                                                                   | Intro to Tidyverse DC 1<br/>RStudio IDE DC 1<br/>Final Project |                                                                                  | MD 2<br/>R4DS 4                                                                         |
| 1b <br/>(Sep 27) |                                                | The Data Science pipeline and getting your computer ready                                                               | Getting ready, Intro to R and R Studio                                                            | Lab<br/>Intro to Tidyverse DC 2<br/>RStudio IDE DC 3           | <br/>Intro to Tidyverse DC 1<br/>RStudio IDE DC 1                                | MD 1.1<br/>R4DS 6                                                                       |
| 2a <br/>(Oct 2)  | Introduction to data visualization             | Data visualization with ggplot2; Grammar of Graphics                                                                    | Scatterplots with smooths, line plots                                                             | Lab<br/>Intro to Tidyverse DC 3                                | Intro to Tidyverse DC  2<br/>RStudio IDE DC 3<br/>Final Project Groups Finalized | MD 3.1-3.4<br/>R4DS 3.1-3.6                                                             |
| 2b <br/>(Oct 4)  |                                                | More data vis basics with ggplot2                                                                                       | histograms, boxplots, barplots                                                                    | Lab<br/>Intro to Tidyverse DC 4                                | Intro to Tidyverse DC 4<br/>Lab (Scatterplots with smooths, line plots)          | MD 3.5-3.9<br/>R4DS 3.7-3.10<br/>Healy 3                                                |
| 3a <br/>(Oct 9)  | Basic data wrangling                           | Data wrangling with dplyr (skimr, ggplot2 with summarized data) <br/>R Sudio Projects<br/>Importing flat files with rio | import different data types<br/>skimr<br/>group_by %>% summarize                                  | Intro to Tidyverse DC 3<br/>Lab                                | <br/>Lab (histograms, boxplots, barplots)<br/>Intro to Tidyverse DC 4            | MD 5.1-5.7<br/>R4DS 8<br/>rio vignette (skim)                                           |
| 3b<br/>(Oct 11)  |                                                | More data wrangling with dplyr                                                                                          | The lesser known stars of dplyr                                                                   | Lab                                                            | Intro to Tidyverse DC 3<br/>Lab (importing, skimming, and summarizing)           | R4DS 5<br/>MD 5.9                                                                       |
| 4a<br/>(Oct 16)  | Dynamic and reproducible documents             | Intro to R Markdown <br/>Workflow advice (here::here)                                                                   | Put your scripts into an Rmd <br/>(one complete knitted file)                                     | <br/>Lab<br/>R Markdown DC 1-3                                 | <br/>Lab (The lesser known stars of dplyr)                                       | R4DS 27<br/>Bryan 4-8 (9 optional), 13<br/>https://github.com/jennybc/here_here         |
| 4b<br/>(Oct 18)  |                                                | GitHub                                                                                                                  | Push Rmd + project to GitHub<br/>Case study with dplyr & ggplot2 in Rmd/github_document on GitHub | Lab                                                            | R Markdown DC 1-3<br/>Lab (RMD Script)                                           | Bryan 19, 23-28                                                                         |
| 5a<br/>(Oct 23)  | Dynamic and reproducible APA manuscripts       | Intro to the papaja package                                                                                             | Transform your prior Rmd to an APA Doc                                                            | Lab                                                            | <br/>Lab (Push Rmd + project to GitHub)                                          | Aust & Barth: 2                                                                         |
| 5b<br/>(Oct 25)  |                                                | Citations, equations, and formatting concerns                                                                           | Prettifying your APA doc                                                                          | Lab<br/>Hill DC 1 & 2                                          | Final Project Outline<br/>Lab (Transform your prior Rmd to an APA Doc)           | Aust & Barth: 3-4                                                                       |
| 6a<br/>(Oct 30)  | Tidy data 1                                    | Taming and tidying data                                                                                                 | Hill DC 3                                                                                         | Lab                                                            | Hill DC 1 & 2<br/>LAB (Prettifying your doc)                                     | R4DS12<br/>Wickham (2014): http://www.jstatsoft.org/v59/i10/paper<br/>MD 4.1 - 4.2; 4.4 |
| 6b<br/>(Nov 1)   |                                                | Taming variables                                                                                                        | Hill DC 4                                                                                         | Lab<br/>erob DC 1-3                                            | <br/>Lab (Hill DC 3)                                                             | R4DS 14, 16                                                                             |
| 7a<br/>(Nov 6)   | Taming unwieldy variables                      | Taming variables (Part 2)                                                                                               | erob DC 4                                                                                         | Lab                                                            | Lab (Hill DC 4)<br/>erob DC (Ch 1-3)                                             | R4DS 15                                                                                 |
| 7b<br/>(Nov 8)   |                                                | Work day: (import + tame + tidy)                                                                                        |                                                                                                   |                                                                | Lab (erob DC 4)                                                                  |                                                                                         |
| 8a<br/>(Nov 13)  | Exploratory data analysis                      | Exploratory data analysis / Review dplyr & ggplot2                                                                      | EDA case study                                                                                    | Lab                                                            |                                                                                  | R4DS 7                                                                                  |
| 8b<br/>(Nov 15)  |                                                | Work day                                                                                                                |                                                                                                   | <br/>                                                          | <br/>EDA case study<br/>Final Project Data Script Draft                          |                                                                                         |
| 9a<br/>(Nov 20)  | Review and work week                           | RMD slides, review, and more GitHub                                                                                     | Publish slides in GH                                                                              | Lab                                                            |                                                                                  |                                                                                         |
| 9b<br/>(Nov 22)  |                                                | Looking forward to Course 2 & Work Day                                                                                  |                                                                                                   |                                                                | **Publish slides in GH<br/>Peer Review Final Project Data Script**               |                                                                                         |
| 10a<br/>(Nov 27) | Final Presentations                            | Student Presentations 1                                                                                                 |                                                                                                   |                                                                | **Final project slides (published)**                                             |                                                                                         |
| 10b<br/>(Nov 29) |                                                | Student Presentations 2                                                                                                 |                                                                                                   |                                                                |                                                                                  |                                                                                         |
